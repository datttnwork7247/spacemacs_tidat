...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     (lux-mode :location (recipe
                          :fetcher github
                          :repo "datttnwork7247/lux"
                          :files ("emacs/*.el")
                          ))
     )
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-search-tools '("ack" "grep" "rg" "ag" "pt")
...
before packages are loaded."
  ...
  ;; TODO: CLEANUP BELOWING CONFIG
  ;; -----------------------------------------------------------------------------
  ;; KEYS BINDINGS
  ;; -----------------------------------------------------------------------------
  ;; Basic key bindings for emacs
  ...
  ;; (global-set-key "\C-cs" 'spacemacs/helm-dir-do-ack-region-or-symbol)
  ;; (global-set-key "\C-cS" 'spacemacs/helm-dir-do-ack)
  (global-set-key "\C-cS" 'spacemacs/helm-files-do-ack-region-or-symbol)
  (global-set-key "\C-cs" 'spacemacs/helm-dir-do-ack-region-or-symbol)
  ...
  (defun my-outline-bindings ()
    ...
    (interactive)
    (local-set-key (kbd "M-[") 'hide-body)
    (local-set-key (kbd "M-]") 'show-all)
  ...
  (use-package eww
    :ensure nil
    :commands eww-open-in-new-buffer eww
    :custom
    ...
    ;; If a webpage requires more than eww can handle, switch to the system
    ;; default by tapping &.
    :bind (("C-<return>" . eww-open-in-new-buffer)
           ("C-c w w" . eww))
    (:map eww-mode-map
          ("C-0" . eww-browse-with-external-browser))
    )
  )
